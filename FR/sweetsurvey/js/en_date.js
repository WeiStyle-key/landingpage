...
function date(n, t) {
    var e, r, u = this,
        o = '[ "dimanche", "lundi", "mardi", "mercredi", "jeudi", "vendredi", "samedi, "janvier", "février", "mars", "avril", "mai", "juin", "juillet", "août", "septembre", "octobre", "novembre", "décembre" ]',
        i = /\\?(.?)/gi,
        c = function (n, t) {
            return r[n] ? r[n]() : t
        },
    ...
    return r = {
        ...
        S: function () {
            var n = r.j(),
                t = n % 10;
            return 3 >= t && 1 == parseInt(n % 100 / 10, 10) && (t = 0), ["er", "nd", "rd"][t - 1] || "e"
        },
        w: function () {
            return e.getDay()
        },
