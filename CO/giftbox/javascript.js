...
var array_month = new Array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
...
var a2 = ""; // ruta relativa del icono del encabezado derecho
...
var e = "Cada <span class='date_day_week'></span>, ofrecemos a siete visitantes afortunados la oportunidad de ganar un nuevo producto <span class='w_b'></span>."; // explicación
var g = "¡Todo lo que necesitas hacer es elegir la caja correcta!"; // instrucciones caja 1
var h = "Intenta encontrar la <span class='w_b'></span> <span class='w'></span>"; // instrucciones caja 2

var j = "Me gusta"; // Me gusta
var k = 4281; // Me gusta en la página
...
"2": "Queremos agradecerte por tu lealtad a <span class='spo'></span>, y ofrecerte la oportunidad de ganar el nuevo <strong><span class='w_b'></span> <span class='w'></span></strong> hoy.",
"3": "Todo lo que tienes que hacer es elegir la caja de regalo correcta.",
"4": "<strong>Tienes 3 intentos, ¡buena suerte!</strong>",
}];
var m_1_b = 'OK'; // Botón del Modal 1

var m_2_i = 's.png'; // Imagen del Modal 2
var m_2_d_2 = '(2) intentos más';
var m_2_d_1 = '(1) intento más';
var m_2_d = '¡Lo siento, esta caja de regalo está vacía! Aún te quedan <span id="try"></span>. ¡Buena suerte!'; // Descripción del Modal 2
var m_2_b = 'OK'; // Botón del Modal 2

var m_3_i = 'prize.png'; // Imagen del Modal 3
var m_3_t = '¡Felicidades!'; // Título del Modal 3
var m_3_s = '(1) <span class="w_b"></span> <span class="w"></span> está reservado(a) para ti.'; // Título del Modal 3
var m_3_d = [{ // Descripción del Modal 3
"1": "1. Confirma tu información de contacto y dirección de entrega en la siguiente página.",
"2": "2. Paga la tarifa de envío y manipulación.",
"3": "3. Tu <span class='w_b'></span> <span class='w'></span> será entregado(a) a la dirección especificada en un plazo de 3 a 5 días hábiles.",
}];
var m_3_b = 'OK'; // Botón del Modal 3
...
var i = [{
	...
	"time": "Hace 5 minutos",
	"comment": {
	"1": "¡Lo conseguí en mi segundo intento! ¡Oh yeah!",
	}
	},
	"3": {
	"name": "Valerie Clumy",
	...
	"time": "Hace 1 hora",
	"comment": {
	"1": "Pensé que era una broma, pero mi <span class='w'></span> llegó esta mañana. Sin embargo, debes seguir las instrucciones cuidadosamente.",
	}
	},
	"7": {
	"name": "Kevin Mundie",
